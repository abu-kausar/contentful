...
const LandingHero = ({ title, description } : LandingHeroFields) => {
  return (
    <div className="flex flex-col md:items-center md:flex-row md:min-h-3/4-screen">
      <div className="w-full md:w-1/2 bg-texture border-none flex justify-center items-center py-5 md:pb-10">
        <div className="px-8 md:px-16 opacity-100 transition-opacity text-white">
      ...
      <div className="w-full md:w-1/2 opacity-100 transition-opacity md:pr-10">
        <LargeVideo />
      </div>
    </div>
  );
